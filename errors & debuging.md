### Error-1:
Error: (rsnm)Unknown subckt: xcell1 wl bl blb vdd vss q1 qb1 vsweep vss Simulation interrupted due to error!  
...
### Error-2:
PROBLEM: (amplifier)The graph's time axis goes from -1.0 to 1.0 seconds instead of 0 to 4 nanoseconds, and there are no colored lines.  
...
### Error-3:
PROBLEM:(amplifier)the circuit is executing a weird jump: v(sa_out) (the blue line) drops down to 0.6V instantly at time zero ($t=0$), long before your red enable signal (sa_en) even fires at 1.5ns.  
